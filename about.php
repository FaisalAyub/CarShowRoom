					...
					<div class="heading-content-bg wow fadeIn" data-wow-delay="0.75s" data-wow-duration="1s">
						<div class="row">
							<div class="heading-content col-md-12">
								<p><a href="index-2.html">Homepage</a> / <em> About</em></p>
...
<section>
		<div class="latest-news">
						...
						<div class="col-md-12">
							<div class="section-heading">
								...
								<div class="text-content">
									<h2>About Us</h2>
									<span>Cars of the Palm beach Concours.</span>
								</div>
							</div>
						</div>
					</div>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-12">
						<div class="item wow fadeIn animated" data-wow-duration="0.75s" style="visibility: visible;-webkit-animation-duration: 0.75s; -moz-animation-duration: 0.75s; animation-duration: 0.75s;">
