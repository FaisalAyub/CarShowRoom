					...
					<div class="heading-content-bg wow fadeIn" data-wow-delay="0.75s" data-wow-duration="1s">
						<div class="row">
							<div class="heading-content col-md-12">
								<p><a href="index-2.html">Homepage</a> / <em> Car Entry Form</em></p>
								<h2>Add New <em>Car</em></h2>
							</div>
						</div>
					</div>
				</div>
                            ...
                            <div class="  row">
                                ...
                                <div class=" col-md-9 col-sm-9 col-xs-6">
                                    ...
                                    while ($data = mysqli_fetch_array($result)) {
                                        ...
                                        echo '  <input id="checkbox' . $data['Id'] . '" style="width:50px" class="styled" type="checkbox" name="check_list[]" value="' . $data['Id'] . '" >';
